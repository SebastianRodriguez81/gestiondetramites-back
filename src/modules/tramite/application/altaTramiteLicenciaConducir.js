function crearAltaTramiteLicenciaConducir(tramiteLicenciaConducir) {
    return {
        async ejecutar(tramiteLicenciaConducirData) {
            ...
            const cantEst1 = await tramiteLicenciaConducir.tramite.buscarTodos(1, 1, null, null, tramiteLicenciaConducirData.usuariosId, null)
            const cantEst2 = await tramiteLicenciaConducir.tramite.buscarTodos(2, 1, null, null, tramiteLicenciaConducirData.usuariosId, null)            
